    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <FormProvider methods={methods} onSubmit={onSubmit}>
          ...
          <Typography variant="body2" sx={{ mb: 2, color: 'text.secondary' }}>
            {t('user:education_help')}
          </Typography>

          {/* Education List */}
          {methods.watch('education')?.map((_, index) => (
            <Card key={index} sx={{ p: 3, mb: 2, bgcolor: 'grey.50' }}>
              <Box
                sx={{
                  display: 'flex',
              ...
              >
                ...
                <Button
                  ...
                  size="small"
                  onClick={() => {
                    const currentEducation = methods.getValues('education');
                    const newEducation = currentEducation.filter((_, i) => i !== index);
                    methods.setValue('education', newEducation);
                  }}
                >
                  {t('common:remove')}
                </Button>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  ...
                  <RHFTextField
                    ...
                    helperText={t('user:degree_help')}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                    {t('user:field_of_study')}
                  </Typography>
                  <RHFTextField
                    name={`education.${index}.field`}
                    placeholder={t('user:enter_field_of_study')}
                    helperText={t('user:field_of_study_help')}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                  ...
                  <RHFTextField
                    ...
                    helperText={t('user:institution_help')}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                    {t('user:graduation_year')}
                  </Typography>
                  <RHFTextField
                    name={`education.${index}.year`}
                    placeholder={t('user:enter_graduation_year')}
                    helperText={t('user:graduation_year_help')}
                  />
                </Grid>
              </Grid>
            </Card>
          ...
          <Typography variant="body2" sx={{ mb: 2, color: 'text.secondary' }}>
            {t('user:professional_background_help')}
          </Typography>

          {/* Professional Background List */}
          {methods.watch('professionalBackground')?.map((_, index) => (
            <Card key={index} sx={{ p: 3, mb: 2, bgcolor: 'grey.50' }}>
              <Box
                sx={{
                  display: 'flex',
                ...
                <Button
                  ...
                  onClick={() => {
                    const currentProfessionalBackground =
                      methods.getValues('professionalBackground');
                    const newProfessionalBackground = currentProfessionalBackground.filter(
                      (_, i) => i !== index
                    );
                    methods.setValue('professionalBackground', newProfessionalBackground);
                  }}
                >
                  {t('common:remove')}
                </Button>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  ...
                  <RHFTextField
                    name={`professionalBackground.${index}.title`}
                    placeholder={t('user:enter_job_title')}
                    helperText={t('user:job_title_help')}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                  ...
                  <RHFTextField
                    name={`professionalBackground.${index}.company`}
                    placeholder={t('user:enter_company')}
                    helperText={t('user:company_help')}
                  />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                  ...
                  <RHFTextField
                    name={`professionalBackground.${index}.duration`}
                    placeholder={t('user:enter_duration')}
                    helperText={t('user:duration_help')}
                  />
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                  ...
                  <RHFTextField
                    name={`professionalBackground.${index}.description`}
                    placeholder={t('user:enter_job_description')}
                    multiline
                    rows={3}
                    helperText={t('user:job_description_help')}
                  />
                </Grid>
              </Grid>
            </Card>
          ...
          <Button
            ...
            onClick={() => {
              const currentProfessionalBackground =
                methods.getValues('professionalBackground') || [];
              methods.setValue('professionalBackground', [
          ...
          <Typography variant="body2" sx={{ mb: 2, color: 'text.secondary' }}>
            {t('user:achievements_help')}
          </Typography>

          {/* Achievements List */}
          {methods.watch('achievements')?.map((_, index) => (
            <Card key={index} sx={{ p: 3, mb: 2, bgcolor: 'grey.50' }}>
              <Box
                sx={{
                  display: 'flex',
              ...
              >
                ...
                <Button
                  ...
                  size="small"
                  onClick={() => {
                    const currentAchievements = methods.getValues('achievements');
                    const newAchievements = currentAchievements.filter((_, i) => i !== index);
                    methods.setValue('achievements', newAchievements);
                  }}
                >
                  {t('common:remove')}
                </Button>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Typography variant="body2" sx={{ mb: 1, fontWeight: 500 }}>
                    {t('user:achievement_description')}
                  </Typography>
                  <RHFTextField
                    ...
                    multiline
                    rows={2}
                    helperText={t('user:achievement_help')}
                  />
                </Grid>
              </Grid>
            </Card>
          ...
          <Button
            ...
            onClick={() => {
              const currentAchievements = methods.getValues('achievements') || [];
              methods.setValue('achievements', [...currentAchievements, '']);
            }}
            sx={{ mb: 4 }}
          >
